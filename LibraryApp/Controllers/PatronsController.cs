...
namespace LibraryApp.Controllers
{
    public class PatronsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PatronID,FirstName,LastName")] Patron patron)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PatronID,FirstName,LastName")] Patron patron)
        {
            if (ModelState.IsValid)
            {
